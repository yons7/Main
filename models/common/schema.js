...
<<<<<<< HEAD
    ...
    natureSpendingSchema.pre('save', function (next) {
        var natureSpending = this;
        handleDates(natureSpending); // on every save, add the date    
        next();
    });
=======
>>>>>>> origin/master
...
<<<<<<< HEAD
                ...
                NatureSpendings : connection.model('natureSpendings', natureSpendingSchema)                                          
=======
                Scales          : connection.model('scales', scaleSchema)                               
>>>>>>> origin/master
=======
